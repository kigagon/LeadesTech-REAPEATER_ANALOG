...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA7     ------> ADC1_IN14
    */
    GPIO_InitStruct.Pin = a_IN_A_ADC_r_CON_OUT_RSET_Pin|a_COM_ADC_r_SIG24_ADC_Pin|a_OUT_B_ADC_r_OUT_A_ADC_Pin|a_TEMP_SEN_r_OUT_B_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = a_SMOKE_ADC_OP_r_OUT_ADC_Pin|a_OUT_A_ADC_r_OUT4_Pin|a_op1_vout_r_OUT3_Pin|a_OUT_ADC_r_OUT1_Pin
                          |a_IN_B_ADC_r_OCP4_Pin|a_IN_ADC_r_OCP3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA7     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(GPIOC, a_IN_A_ADC_r_CON_OUT_RSET_Pin|a_COM_ADC_r_SIG24_ADC_Pin|a_OUT_B_ADC_r_OUT_A_ADC_Pin|a_TEMP_SEN_r_OUT_B_ADC_Pin);

    HAL_GPIO_DeInit(GPIOA, a_SMOKE_ADC_OP_r_OUT_ADC_Pin|a_OUT_A_ADC_r_OUT4_Pin|a_op1_vout_r_OUT3_Pin|a_OUT_ADC_r_OUT1_Pin
                          |a_IN_B_ADC_r_OCP4_Pin|a_IN_ADC_r_OCP3_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if(hdac->Instance==DAC1)
  {
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(a_IR_LED_DAC_r_OUT2_GPIO_Port, a_IR_LED_DAC_r_OUT2_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = a_SCL_r_DISCON3_Pin|a_SDA_r_DISCON4_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(a_SCL_r_DISCON3_GPIO_Port, a_SCL_r_DISCON3_Pin);

    HAL_GPIO_DeInit(a_SDA_r_DISCON4_GPIO_Port, a_SDA_r_DISCON4_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    */
    ...
    __HAL_LINKDMA(huart,hdmatx,hdma_lpuart2_tx);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VOUT
    */
    GPIO_InitStruct.Pin = a_SMOKE_ADC_OP_r_OUT_ADC_Pin|a_OPAMP_IN_M_r_DC_24V_Pin|a_op1_vout_r_OUT3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VOUT
    */
    HAL_GPIO_DeInit(GPIOA, a_SMOKE_ADC_OP_r_OUT_ADC_Pin|a_OPAMP_IN_M_r_DC_24V_Pin|a_op1_vout_r_OUT3_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI3)
  {
    ...
    PC12     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = a_SCK_r_DIP_ADD3_Pin|a_MISO_DIP_ADD2_Pin|a_MOSI_r_DIP_ADD1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI3)
  {
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, a_SCK_r_DIP_ADD3_Pin|a_MISO_DIP_ADD2_Pin|a_MOSI_r_DIP_ADD1_Pin);
