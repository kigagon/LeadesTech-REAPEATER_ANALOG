...
uint32_t photoADC_Required4SlopeCalculation_ADDR = ADDR_FLASH_PAGE_61;
uint32_t Adjust_Y_Intercept_ADDR = ADDR_FLASH_PAGE_60;
uint32_t FinalPcntVal_Required4SlopeCalculation_ADDR = ADDR_FLASH_PAGE_59;
uint32_t SMOKE_DAC_Multiplied_10_ADDR = ADDR_FLASH_PAGE_58;
uint32_t SMOKE_PGA_ADDR = ADDR_FLASH_PAGE_57;

uint32_t ISO_STATUS_ADDR = ADDR_FLASH_PAGE_56;
